...
const Busines  = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=busines&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=business-meeting&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=business-woman&client_id=${accessKey}&count=50`
    );
    return (
