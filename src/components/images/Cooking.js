...
const Cooking = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=cooking&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=cooking-mom&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=cooking-asian&client_id=${accessKey}&count=50`
    );
    return (
