...
const Date  = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=date-night&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=date-girls&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=nature-girl&client_id=${accessKey}&count=50`
    );
    return (
