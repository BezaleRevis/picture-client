...
const Dogs  = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=dogs&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=dogs-girls&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=dog-and-girl&client_id=${accessKey}&count=50`
    );
    return (
