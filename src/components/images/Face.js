...
const Face = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=face&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=face-girl&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=face-naked&client_id=${accessKey}&count=50`
    );
    return (
