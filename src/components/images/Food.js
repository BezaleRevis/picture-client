...
const Food  = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=food&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=food-girls&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=food-photography&client_id=${accessKey}&count=50`
    );
    return (
