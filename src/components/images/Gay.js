...
const Gay  = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=gay&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=gay-man&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=gay-couple&client_id=${accessKey}&count=50`
    );
    return (
