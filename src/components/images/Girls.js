...
const Girls = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=girls&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=girls-night&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=girls-trip&client_id=${accessKey}&count=50`
    );
    return (
