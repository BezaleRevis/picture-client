...
const Man  = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=man&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=nature-man-alone&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=man-fashion&client_id=${accessKey}&count=50`
    );
    return (
