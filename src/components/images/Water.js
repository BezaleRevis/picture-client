...
const Nature  = () => {
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=water&client_id=${accessKey}&count=50`
    );
    const {
      data: images1,
      error1,
      ...
      `${apiUnsplash}/photos/random?query=water-drop&client_id=${accessKey}&count=50`
    );
    ...
    const {
      ...
      `${apiUnsplash}/photos/random?query=water-girls&client_id=${accessKey}&count=50`
    );
    return (
